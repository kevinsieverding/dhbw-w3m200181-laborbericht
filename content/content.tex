...
Über den API-Endpunkt \path{/warnings} können alle gespeicherten Warnungen abgefragt werden, während der Endpunkt \path{/warnings/:is} es erlaubt eine bestimmte Warnung abzufragen.
